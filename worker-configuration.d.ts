/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6cb13805ddc0ff98c915fa3f9f5eae35)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WIKIMEDIA_USER_AGENT">> {}
}
